                            ...
                            <div className="row">
                                <div className="col-xl-3 col-md-6">
                                    <div className="card bg-primary text-white mb-4">
                                        <div className="card-body">Employee Table</div>
                                        <div className="card-footer d-flex align-items-center justify-content-between">
                                            <a className="small text-white stretched-link" href="/employeeTable">View
                                                Details</a>
                                ...
                                <div className="col-xl-3 col-md-6">
                                    <div className="card bg-warning text-white mb-4">
                                        <div className="card-body">Company Table</div>
                                        <div className="card-footer d-flex align-items-center justify-content-between">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    <div className="card bg-success text-white mb-4">
                                        ...
                                        <div className="card-footer d-flex align-items-center justify-content-between">
                                            <a className="small text-white stretched-link" href="/buildingEmployee">View
                                                Details</a>
                                            <div className="small text-white"><i className="fas fa-angle-right"></i>
                                            </div>
                                        </div>
                                ...
                                <div className="col-xl-3 col-md-6">
                                    <div className="card bg-danger text-white mb-4">
                                        ...
                                        <div className="card-footer d-flex align-items-center justify-content-between">
                                            <a className="small text-white stretched-link" href="/buildingService">View
                                                Details</a>
                                            <div className="small text-white"><i className="fas fa-angle-right"></i>
                                            </div>
                                        </div>
